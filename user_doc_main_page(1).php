...
<a href="patient_details(1).php" class="list-group-item " style="height:100px;background-color:#D8D8D8;color:#000000;margin-top:20px"><h4>Request Appointment</h4></a>
...
<a href="update_password(1).php" class="list-group-item " style="height:100px;background-color:#D8D8D8;color:#000000;margin-top:20px""><h4>Change Password</h4></a>
...
<br><h2 style="margin-left:70px">My Profile</h2>
<a href="user_update_profile(1).php" style="margin-left:70px;margin-top:15px">Update Profile</a>
</div>
</div>
</div>
<div class="col-md-4">
...
<h2 style="margin-left:30px">Request an Appointment</h2>
<a href="patient_details(1).php" style="margin-left:30px">Request an Appointment</a>
</div>
</div>
</div>
