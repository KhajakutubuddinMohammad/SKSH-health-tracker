...
<a href="doctors_appointment(1).php" class="btn btn-primary" style="background-color:#A4A4A4; color:#000000; position:relative;top:0;right:0;float:right">Back to main page</a></button>
</div>
<div class="container-fluid">
<div class="row">
<div class="col-md-3">
...
<a href="patient_details.php" class="list-group-item">Book appointment</a>
<a href="patient_search.php" class="list-group-item">patient search</a>
<a href="Discharge patient" class="list-group-item">Discharge Patient</a>
...
<a href="doctor_details.php" class="list-group-item ">Doctors  details</a>
<a href="" class="list-group-item ">Add or remove doctors</a>
<a href="doctor_search.php" class="list-group-item">Doctor search</a>
...
<div class="card-body">
<form class="form-group" method="post" action="doctor_login_func.php">
