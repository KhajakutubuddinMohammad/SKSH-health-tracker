...
<form class="form-group" action="admin_login_func(1).php" method="post">
<div class="card">
...
<div  class="row">
<div class="col-md-6">
<a href="admin_register(1).php" class="btn btn-default">Register</a></div>
<div class="col-md-6">
<a href="admin_login_page(1).php" class="btn btn-default">Login</a></div>
</row>
</form>
</div>
<div class="card-body">
