...
<a href="user_doc_main_page(1).php" style="float:right" class="btn btn-primary"><i class="fas fa-arrow-alt-circle-left"></i>Go back</a>
</div>
...
<div class="card-body">
<form class="form-group" method="post" action="user_update_password(1).php">
