...
<a href="doctor_appointment(1).php" style="float:right" class="btn btn-primary"><i class="fas fa-arrow-alt-circle-left"></i>Go back</a>
</div>
...
<div class="card-body">
<form class="form-group" method="post" action="admin_update_password(1).php">
<label>Enter Admin Name:</label><br>
<input type="text" name="card_name" class="form-control">
<label>Enter Admin Email id:</label><br>
